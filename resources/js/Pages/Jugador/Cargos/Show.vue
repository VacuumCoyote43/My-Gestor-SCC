    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <Link v-if="puedeRegistrarPago()" :href="route('jugador.cargos.pagos.create', cargo.id)" class="inline-flex items-center px-4 py-2 text-white bg-green-600 rounded-md hover:bg-green-700">
                    Registrar Pago
                </Link>
            </div>
        </template>
