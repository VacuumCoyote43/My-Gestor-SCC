        ...
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-2">
                    <Link v-if="factura.estado === 'draft'" :href="route('club.facturas.edit', factura.id)" class="inline-flex items-center px-4 py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700">
                        Editar
                    </Link>
